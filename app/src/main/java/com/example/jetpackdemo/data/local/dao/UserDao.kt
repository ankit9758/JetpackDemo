...
interface UserDao {
    ...
    @Query("UPDATE user_table SET username = :username, imageUrl = :imageUrl,phoneNumber = :phoneNumber WHERE email = :email")
    suspend fun updateProfileData(username: String,imageUrl: String,phoneNumber: String,email: String):Int
}